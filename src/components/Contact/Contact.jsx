      ...
      <div className="flex flex-col md:flex-row w-[90%] my-[104px] mx-auto">
        ...
        <div className="w-full md:w-1/2 bg-[#F8F9FA] p-10 px-4 sm:p-20 md:p-[104px]">
          <div>
            ...
            <div className="flex flex-col mb-10">
              <label htmlFor="message" className="font-bold mb-[18px]">Messages</label>
              <textarea id="message" rows={5} placeholder="Write your messages here" className="bg-[#FEFFFF] p-[14px] placeholder:text-[#999] resize-none" />
            </div>
          </div>
        </div>
      </div>
