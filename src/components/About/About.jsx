...
const About = () => {
  return (
    <section id="about" className="mt-20 pt-20 md:mt-10">
      <div className="w-[90%] mx-auto max-w-[1200px] -mb-20">
        ...
        <div>
          <div className='flex justify-center items-center w-[90%] sm:w-4/5 md:w-1/2 max-w-[856px] mx-auto mt-8 md:mt-[59px]'>
            <img src={hamburger} alt="Hamburger" />
          </div>
        </div>
      </div>
      <div className='rotate-180 w-full absolute overflow-hidden left-0'>
